...
def tune_teacher3(X, y):
    tune_results = {}
    mean_results = []
    params = [(num_of_teachers, sample_percentage) for num_of_teachers in [3, 5, 7] for sample_percentage in
              [0.6, 0.7, 0.8]]
    ...
    for num_of_teachers, sample_percentage in params:
        ...
        plt.title(
            f"Mistakes made over time of Teacher3_optimized=True_with_params=({num_of_teachers}, {sample_percentage})")
